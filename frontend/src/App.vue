...
const submitPrediction = async (type) => {
  ...
  try {
    ...
    if (isSingle) singleFile.value = null;
    else batchFile.value = null;
                ...
                >
                  <v-chart
                    ...
                    :option="getChartOption(
                      lang === 'zh' ? pred.disease_name_cn : pred.disease_name_en,
                      pred.probability
                    )"
                    autoresize
                  />
...
.stat-item .stat-value {
  ...
  font-family: 'DIN-Alternate-Bold', 'Helvetica Neue', sans-serif;
}
